...
<div align="center">
<br/>
    <h3><b>Conference Room Reservation</b></h3>
...
- [📖 React Capston Project ](#-react-capstone-project-)
...
# 📖 Conference Room Reservation <a name="about-project"></a>
...
- **Show reservation before saving**
...
```sh
  cd my-folder
  git clone https://github.com/SFarida/conference-room-reservation.git
```
-
...
Feel free to check the [issues page](https://github.com/SFarida/conference-room-reservation).
